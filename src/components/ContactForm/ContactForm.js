...
export class ContactForm extends Component {
    ...
    render() {
        const { name, number } = this.state;
        const { ContactNameID, contactNumberID, handleSubmit, handleChange, onAddContact } = this;
        return (
            <form onSubmit={handleSubmit}>
                <div className={styles.contact_form_container}>
                    <div className={styles.contact_form_item}>
                        <label className={styles.contact_form_label}
                            htmlFor={ContactNameID}>Contact name:</label>
                    ...
                    <div className={styles.contact_form_item}>
                        <label className={styles.contact_form_label}
                            htmlFor={contactNumberID}>Contact number:</label>
                        <input id={contactNumberID}
                            type="tel"
                            name="number"
